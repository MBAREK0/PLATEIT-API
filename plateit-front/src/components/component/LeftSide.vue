<template>
    <div class="  flex flex-col gap-4 mx-4 h-screen">
        ...
        <div class="flex flex-col gap-4 justify-between w-full h-full">
                ...
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center  ">
                    <span class="material-icons lg:text-2xl xl:text-4xl 2xl:text-4xl cursor-pointer">search</span>
                    <p class="lg:text-xl xl:text-2xl  hover:ms-3 translate-x-0 duration-75 cursor-pointer  inter">Explore</p>
                </div>
                <!-- ------------------- -->
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center ">
                    <span class="material-icons lg:text-2xl xl:text-4xl 2xl:text-4xl cursor-pointer">home</span>
                    <p class="lg:text-xl xl:text-2xl   hover:ms-3 translate-x-0 duration-75 cursor-pointer inter">Home</p>
                </div>
                <!-- ------------------- -->
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center ">
                    <span class="material-icons lg:text-2xl xl:text-4xl 2xl:text-4xl p-0 m-0 cursor-pointer">notifications</span>
                    <p class="lg:text-xl xl:text-2xl  hover:ms-3 translate-x-0 duration-75 cursor-pointer  inter">Notifications</p>
                </div>
                <!-- ------------------- -->
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center cursor-pointer">
                    ...
                    <p class="lg:text-xl xl:text-2xl hover:ms-3 translate-x-0 duration-75 cursor-pointer roboto">1250</p>
                </div>
                <!-- ------------------- -->
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center cursor-pointer">
                    ...
                    <p class="lg:text-xl xl:text-2xl hover:ms-3 translate-x-0 duration-75 cursor-pointer inter">Save</p>
                </div>
                <!-- ------------------- -->
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center ">
                    <span class="material-icons lg:text-2xl xl:text-4xl 2xl:text-4xl p-0 m-0 cursor-pointer">person</span>
                    <p class="lg:text-xl xl:text-2xl hover:ms-3 translate-x-0 duration-75 cursor-pointer inter">Profile</p>
                </div>
                <!-- ------------------- -->
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center ">
                    <span class="material-icons lg:text-2xl xl:text-4xl 2xl:text-4xl p-0 m-0 cursor-pointer">info</span>
                    <p class="lg:text-xl xl:text-2xl hover:ms-3 translate-x-0 duration-75 cursor-pointer inter">About Us</p>
                </div>
                <!-- ------------------- -->
                <div class=" flex gap-4 md:gap-2 sm:gap-1 items-center ">
                    <span class="material-icons lg:text-2xl xl:text-4xl 2xl:text-4xl p-0 m-0  cursor-pointer">settings</span>
                    <p class="lg:text-xl xl:text-2xl hover:ms-3 translate-x-0 duration-75 cursor-pointer inter">Settings</p>
                </div>
                <!-- ------------------- -->
